...
\lstset{ 
  ...
  tabsize=0,	                   % sets default tabsize to 2 spaces
...
\lstinputlisting[language=Python, caption=Representación con un grafo de ocho estaciones de la Línea 2 del Metro de Monterrey.]{Ej1.py}
...
\lstinputlisting[language=Python, caption=Relaciones de amistad en un grupo de personas.]{Ej2.py}
...
\lstinputlisting[language=Python, caption=Estado de cría de razas de perro.]{Ej3.py}
...
\lstinputlisting[language=Python, caption=Representación de la transmisión de una ITS en un grupo de personas.]{Ej4.py}
...
\lstinputlisting[language=Python, caption= Representación de carreteras de doble sentido en Santiago de Cuba.]{Ej5.py}
...
\lstinputlisting[language=Python, caption= Representación de personas mirando perfiles en redes sociales.]{Ej6.py}
...
\lstinputlisting[language=Python, caption= Posible ruta entre Santiago de Cuba y Holguín.]{Ej7.py}
...
\lstinputlisting[language=Python, caption= Canales para irrigación del suelo creados en la presa El cacao.]{Ej8.py}
...
\lstinputlisting[language=Python, caption= Concurso de habilidades.]{Ej9.py}
...
\lstinputlisting[language=Python, caption= Representación del delta de un río en su transcurso hacia el mar.]{Ej10.py}
...
\lstinputlisting[language=Python, caption= Representación de las posibles maneras de elegir la ruta de un circuito vacacional.]{Ej11.py}
...
\lstinputlisting[language=Python, caption= Representación con grafos del intervalo PR.]{Ej12.py}
