...
En el cuadro \pageref{Cuadro 3} se observa que entre grafos de 100 y 200 nodos no hay un efecto significativo en el tiempo de ejecución. A madida que aumenta el tamaño el efecto va incrementándose. En la figura 3 puede observarse esto gráficamente en el diagrama de caja y bigotes. 
